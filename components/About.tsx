...
export default function About() {
  ...
  return (
    <section id="about" className="py-8 sm:py-12 px-5 sm:px-6 max-w-4xl mx-auto">
      ...
      <FadeIn>
        <h2 className="text-xs font-mono gradient-text font-bold mb-6 tracking-wide">ABOUT</h2>
      ...
      <FadeInStagger className="grid sm:grid-cols-3 gap-8">
        {skills.map((group) => (
          <FadeInItem key={group.label}>
            <h3 className="text-xs font-mono font-bold mb-3 tracking-wide">{group.label}</h3>
