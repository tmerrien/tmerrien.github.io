...
export default function Education() {
  return (
    <section id="education" className="py-8 sm:py-12 px-5 sm:px-6 max-w-4xl mx-auto">
      ...
      <FadeIn>
        <h2 className="text-xs font-mono gradient-text font-bold mb-6 tracking-wide">EDUCATION &amp; RESEARCH</h2>
      </FadeIn>
      <FadeInStagger>
        <FadeInItem>
          <div className="grid sm:grid-cols-[200px_1fr] gap-4 mb-10">
            ...
            <div>
              <h3 className="text-base font-semibold mb-1">B.Sc. Computer Science (Honours)</h3>
              <p className="text-sm text-muted-foreground mb-4">University of Prince Edward Island — Minor: Physics</p>
              <Card className="bg-gradient-to-br from-card to-[#F8FAFF] dark:from-card dark:to-[#1a1a2e]">
                <CardContent className="pt-5">
                  <p className="text-xs font-mono font-bold gradient-text mb-2 tracking-wide">HONOURS THESIS</p>
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    ...
                    Supports three experimental conditions to study how tone, empathy, refusal strategies, and
                    formatting affect user trust in conversational AI systems.
                  </p>
                </CardContent>
              </Card>
            </div>
        ...
        <FadeInItem>
          <div className="grid sm:grid-cols-[200px_1fr] gap-4">
            ...
            <div>
              <h3 className="text-base font-semibold mb-1">Professional Certificate in Sound Engineering</h3>
